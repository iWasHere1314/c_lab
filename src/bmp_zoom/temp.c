...
int main(int argc, char* argv[])
{
	...
	memset(&old_info,0,sizeof(BITMAPINFOHEADER));
  	...
  	double bili = 12;//把字符串转化为double型
  	printf("%f",bili);
  
	Bmp_Bigger_And_Smaller(old_head,old_info, bili,"/home/professor/MyProgram/c_lab/test.bmp","/home/professor/MyProgram/c_lab/bigger.bmp");
	return 0;
}
